...
namespace AzureCraft.WPF.ViewModels
{
	public class SalesViewModel : Screen
	{
		...
		private async Task ResetSalesViewModel()
		{
			...
			// TODO - Add clearing the selectedCartItem if it does not do it to itself
			await LoadProducts();
		...
		public bool CanAddToCart
		{
			get
			{
				...
				// Make sure somethig is selected
		...
		public bool CanCheckOut
		{
			get
			{
				...
				// Make sure there is somethig in the cart
				if (Cart.Count > 0)
				{
					output = true;
				}
		...
		// Can we just delete this, only reference...
		public IWindowManager Window { get; }
